...
<div
    class="flex w-full max-w-[400px] flex-row items-center justify-between gap-4 rounded-xl border border-theme-text bg-theme-bg p-3"
>
    <div class="flex min-w-0 flex-1 flex-row items-center gap-2">
        ...
        <div class="flex min-w-0 flex-col overflow-hidden">
            ...
            <span class="text-[12px] text-theme-text opacity-75">{song?.artist || 'artist'}</span>
